package net.thebois.critters.entity.custom;
...
public class SlugEntity extends Animal implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
            SynchedEntityData.defineId(SlugEntity.class, EntityDataSerializers.INT);

    public SlugEntity(EntityType<? extends Animal> p_27557_, Level p_27558_) {
